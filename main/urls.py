...
urlpatterns = [
    ...
    path("add-long/", add_long, name="add-long"),
    path("add-kross/", add_kross, name="add-kross"),
    path("add-helps/", add_helps, name="add-helps"),
    ...
    path("add-images/", add_images, name="add-image"),
    ...
    path('delete-long/<int:pk>/', delete_long, name='delete-long'),
    path('delete-kross/<int:pk>/', delete_kross, name='delete-kross'),
    path('delete-helps/<int:pk>/', delete_helps, name='delete-helps'),
