...
urlpatterns = [
    ...
    path("get-player/<int:pk>/", get_pl, name="get-pl"),
    path("get-fc/<int:pk>/", get_fc, name="get-fc"),
    path("get-pro/<int:pk>/", get_pro, name="get-pro"),
    ...
    path("get-squad/<int:pk>/", get_squad, name="get-squad"),
    path("get-preview/<int:pk>/", get_preview, name="get-preview"),
    path("add-staff/", add_staff, name="add-staff"),
    path("add-player/", add_player, name="add-player"),
    path("passes/", add_passes, name="add-passes"),
    ...
    path("add-action/", add_action, name="add-action"),
    ...
    path('delete-action/<int:pk>/', delete_action, name='delete-action'),
